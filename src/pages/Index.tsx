        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mb-12 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <div className="relative max-w-2xl mx-auto">
              ...
              />
              <Button className="absolute right-2 top-1/2 transform -translate-y-1/2 rounded-xl px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 transition-all duration-300">
                Search
              </Button>
            </div>
          </div>
